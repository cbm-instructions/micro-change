...
void setup() {
  ...
  calibrationValue_1 = 117.10; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = 127.69; // uncomment this if you want to set this value in the sketch
